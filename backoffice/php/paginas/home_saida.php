            ...
            <div class="row caixas">
                <div class="col-12 titulo_2 p-4">
                    ...
                    <form action="home.php" >
                        <label>Link da imagem do autor da página <a href="http://localhost/sebastiao_alves/home.php" style="color: #B8860B"><ins>HOME</ins></a>:</label>
                        ...
                        <label>Texto do "Últimos Livros" da página <a href="http://localhost/sebastiao_alves/home.php" style="color: #B8860B"><ins>HOME</ins></a>:</label>
